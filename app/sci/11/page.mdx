...
do: "Research 3 conspiracy theories (including one about cell phone radiation). Then, come up with and execute a plan to fight the misinformation behind one of them."
---
## Episode Doc
...
Just let Mr. Hoff know and follow [these steps](https://hoff.page/public/the+play+book/team+launch) to plan out your project.

---
### Unsure what to work on?
Check out the [play book](https://hoff.page/public/the+play+book/!+what+is+the+play+book%3F). It' a collection of ways you can spend your work time.
...
- [ ] Show off what you did on the [Showcase Slides](https://docs.google.com/presentation/d/14i31mNBxeoZmBeBTbo9kQzT2n_ojbJjt45tKqAnA6Rw/edit#slide=id.p)

---
## The Showcase
*Sept 27*
- [ ] Make sure you have a [Showcase Slide](https://docs.google.com/presentation/d/14i31mNBxeoZmBeBTbo9kQzT2n_ojbJjt45tKqAnA6Rw/edit#slide=id.p)
